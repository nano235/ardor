...
import { getYoutubeEmbedUrl } from "../projectView/ProjectView";
	...
	const nav = [
		{
			...
			video: getYoutubeEmbedUrl(general?.data.promotionVideo as string)
		},
		{
			...
			video: getYoutubeEmbedUrl(general?.data.socialMedia as string)
		},
		{
			title: "Product Demo",
			subTitle: "Where It Works Best",
			...
			video: getYoutubeEmbedUrl(general?.data.productDemo as string)
		},
		{
			...
			video: getYoutubeEmbedUrl(general?.data.brandAnimation as string)
		}
	];
